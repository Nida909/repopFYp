...
public class PaymentActivity extends AppCompatActivity {
    ...
    String price  ;
double p1,p2;
    private final String Jazz_MerchantID      = "MC19085";
    private final String Jazz_Password        = "x0sy4v1v59";
    private final String Jazz_IntegritySalt   = "1u4310v55t";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        java.util.Date currentDateHourPlusOne = c.getTime();
